...
/**
 * Created by codehub on 3/18/16.
 * This class contains all the utilities that are required to run the esaude
 */
public class EsaudeMetadataUtils {
    ...
    public static final class _PackageUuids{
        ...
        public static final String METADATA_DIAGNOSIS_CONCEPTS_GROUP_UUID = "75aaf4eb-8e4d-4e0a-a1a6-c2496eca2e58";
    }
}
